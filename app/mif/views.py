...
def homepage():
    ...
    """
    return render_template('mif/index.html', title="Welcome")

@mif.route('/dashboard1')
@login_required
def dashboard1():
    """
    ...
    return render_template('mif/dashboard1.html', title="Dashboard1")

@mif.route('/dashboard2')
@login_required
def dashboard2():
    """
    ...
    """
    ee = Employee.query.filter_by(department_id=25).first()
    return render_template('mif/dashboard2.html', title="Dashboard2")

@mif.route('/dashboard3')
@login_required
def dashboard3():
    """
    Render the dashboard template on the /dashboard3 route
    """
    return render_template('mif/dashboard3.html', title="Dashboard3")

@mif.route('/dashboard4')
@login_required
def dashboard4():
    """
    Render the dashboard template on the /dashboard4 route
    """
    return render_template('mif/dashboard4.html', title="Dashboard4")    