...
def homepage():
    ...
    """
    return render_template('ea/index.html', title="Welcome")
...
def dashboard1():
    ...
    return render_template('ea/dashboard1.html', title="Dashboard1")
...
def dashboard2():
    ...
    """
    ee = Employee.query.filter_by(department_id=25).first()
    return render_template('ea/dashboard2.html', title="Dashboard2")
...
def dashboard3():
    ...
    """
    return render_template('ea/dashboard3.html', title="Dashboard3")
...
def dashboard4():
    ...
    """
    return render_template('ea/dashboard4.html', title="Dashboard4")    