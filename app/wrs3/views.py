...
def homepage():
    ...
    """
    return render_template('wrs3/index.html', title="Welcome")

@wrs3.route('/dashboard1')
@login_required
def dashboard1():
    """
    ...
    return render_template('wrs3/dashboard1.html', title="Dashboard1")

@wrs3.route('/dashboard2')
@login_required
def dashboard2():
    """
    ...
    """
    ee = Employee.query.filter_by(department_id=19).first()
    return render_template('wrs3/dashboard2.html', title="Dashboard2")

@wrs3.route('/dashboard3')
@login_required
def dashboard3():
    """
    Render the dashboard template on the /dashboard3 route
    """
    return render_template('wrs3/dashboard3.html', title="Dashboard3")

@wrs3.route('/dashboard4')
@login_required
def dashboard4():
    """
    Render the dashboard template on the /dashboard4 route
    """
    return render_template('wrs3/dashboard4.html', title="Dashboard4")    