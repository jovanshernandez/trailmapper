...
def homepage():
    ...
    """
    return render_template('pd/index.html', title="Welcome")
...
def dashboard1():
    ...
    """
    ee = Employee.query.filter_by(department_id=12).first() 
    return render_template('pd/dashboard1.html', title="Dashboard1")
...
def dashboard2():
    ...
    """
    ee = Employee.query.filter_by(department_id=12).first()
    return render_template('pd/dashboard2.html', title="Dashboard2")
...
def dashboard3():
    ...
    """
    return render_template('pd/dashboard3.html', title="Dashboard3")
...
def dashboard4():
    ...
    """
    return render_template('pd/dashboard4.html', title="Dashboard4")    